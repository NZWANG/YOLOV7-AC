...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, TVConv,Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC, ACmix,ACmixblock,ResNet_ACmix,RepACmixblock,GAM_Attention]:
            c1, c2 = ch[f], args[0]
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC,
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC, ACmix,ACmixblock,ResNet_ACmix,RepACmixblock,GAM_Attention]:
